...
[ -z "${REMOTE_URL}" ] && REMOTE_URL=https://github.com/taylor-an/arduino-pico/releases/download
...
curl --silent https://api.github.com/repos/taylor-an/arduino-pico/releases > releases.json
...
curl -L -o $old_json "https://github.com/taylor-an/arduino-pico/releases/download/${base_ver}/package_rp2040_index.json"
